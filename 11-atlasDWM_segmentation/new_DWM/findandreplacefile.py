...
directory = os.path.join(os.getcwd(),"bundles_MNI_atlas_")  # Replace with your directory path
find_text = 'rh_'  # Text you want to replace
replace_text = 'MNI_atlas_rh_'  # Text to replace with
